 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        now                         :   '', // Cuando esté vacío usará la fecha y hora del navegador del usuario, si no, puede asignarlo con formato: AAAA-MM-DD HH:mm:ss (2019-12-30 18:30:00)
        timezone                    :   'America/Santiago', // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
        notAvailableMsg             :   'Estamos fuera de horario', // Mensaje cuando no es un día disponible o una vez pasadas las horas disponibles
        almostAvailableMsg          :   'Estaré disponible pronto', // Si hoy es un día disponible y antes de que empiece el tiempo
        dialogNotAvailableMsg       :   'Estamos fuera de horario', // En el cuadro de diálogo aparecerá un mensaje cuando no sea un día disponible o una vez que hayan pasado las horas disponibles.
        dialogAlmostAvailableMsg    :   'Estaré disponible pronto', // En el cuadro de diálogo si hoy es un día disponible y antes de que comience el tiempo
        defaultMsg                  :   'Hola, tengo algunas preguntas sobre esta página: {{url}}!', // Mensaje de soporte predeterminado   

        // Eventos

        onPopupOpen          : function(){}, //Este evento se activa cuando se abre el modal
        onPopupClose         : function(){}, //Este evento se activa cuando se cierra el modal.
        whenGoingToWhatsApp  : function(number, text){},   //Este evento se activa cuando el complemento te redirige a WhatsApp.
 ...
 * ====================================================================== */    
     ...
     * ====================================================================== */     
        ...
        function go_to_whatsapp(number, text){
            ...
            close_popup();
            var WhatsAppUrl =  'https://web.whatsapp.com/send';'https://wa.me/' //

            if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
                WhatsAppUrl = 'https://api.whatsapp.com/send'; // 'https://wa.me/' //
            }
